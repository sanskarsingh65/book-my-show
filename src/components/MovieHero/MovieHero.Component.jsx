...
const MovieHero = () => {
    ...
    const {movie,buyMovie,rentMovie}=useContext(MovieContext)    
  ...
  return (
    ...
    <div className='absolute z-10 w-full h-full' style={{backgroundImage:"linear-gradient(90deg,rgb(34,34,34)14.95%,rgb(34,34,34)30.3%,rgba(34,34,34,0.90)38.3% ,rgba(34,34,34,0.60)58.3%,rgba(34,34,34,.04)100%)"}}/>

    <div className='absolute z-30 left-24 top-10 flex items-center gap-10'>
        <div className='w-64 h-96 '>
            <img src={`https://image.tmdb.org/t/p/original${movie.poster_path}`} alt="Movie Poster" className='h-full w-full rounded-lg' />
        </div>
        <div className=''>
